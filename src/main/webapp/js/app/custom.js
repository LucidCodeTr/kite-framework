							...
							function() {
								...
								setTimeout(
										function() {
											...
											// You can have it return a unique
											// id, this can be used to manually
								...
								$(".notify")
										.click(
												function(e) {
													...
													// You can have it return a
													// unique id, this can be
													// used to manually remove
													// it later using
													setTimeout(
															function() {
																$.gritter
			...
			$('.slide-box-head').click(
					function() {
						...
						if ($slidebox.css('right') == "-252px") {
							...
							$slidebtn.children("i").removeClass().addClass(
									"icon-chevron-right");
						} else {
							$slidebox.animate({
								right : -252
